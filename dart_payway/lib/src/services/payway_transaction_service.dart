import 'dart:convert';
import 'package:dart_payway/src/enumerations.dart';
import 'package:dart_payway/src/https/https.dart';
import 'package:dart_payway/src/models/models.dart';
import 'package:dart_payway/src/services/services.dart';
...
class PaywayTransactionService {
  ...
  Future<PaywayCreateTransactionResponse> createTransaction(
    ...
    try {
      ...
      if (enabledLogger) {
        PaywayLogger.logger.d(json.encode(map));
